{{--
    Branding "above form" partial — the Logo & Favicon upload card has
    its own POST/DELETE forms, so it must render OUTSIDE the parent
    settings PUT form (HTML forbids nested forms).

    show.blade.php @includeIf-s this partial right BEFORE opening the
    main form. Earlier architecture used @push/@stack to achieve the
    same thing, but the @stack call in show.blade.php yields BEFORE
    the section is included — pushed content never reached the stack.
--}}
@php
