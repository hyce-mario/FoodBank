...
@section('content')
<div class="mb-5">
    <h1 class="text-xl font-bold text-gray-900">Edit Pledge</h1>
...
<form method="POST" action="{{ route('finance.pledges.update', $pledge) }}"
      class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 max-w-3xl">
    @method('PUT')
    @include('finance.pledges._form', ['submitLabel' => 'Update Pledge'])
</form>
@endsection
