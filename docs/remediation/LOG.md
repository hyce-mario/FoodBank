...
| 1.1.c.3 `VisitMonitorController::reorder` swap to `VisitReorderService` | ✅ | _pending_ | ✅ Same race fix applied to admin monitor endpoint via shared service; HTTP feature tests cover all branches incl. `allow_queue_reorder=false → 403` |
